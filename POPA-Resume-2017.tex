...
\item [] Python, R, Matlab, Jupyter, git, SQL, SPSS, DataGraph, \LaTeX\ 
...
\item Developed and shared individual projects using tools including Facebook's publically available package FastText
...
%\end{itemize}
 ...
 \begin{itemize}[leftmargin=-2pt]\itemsep -2pt
 \item[]\textbf{International Rescue Committee}\\Refugee Empowerment Volunteer\hfill (Jan 2017 - Present)
