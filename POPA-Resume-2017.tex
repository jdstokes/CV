...
\item Performed multinomial logistic regression using the nnet package of R to predict five possible outcomes for shelter animal
\item Generated confusion matrices to visualize data
\end{itemize}
...
\item Pre-processed text using bash shell scripts
